    ...
    <div class="min-h-screen flex flex-col flex-auto flex-shrink-0 antialiased bg-gray-900 text-black dark:text-white">
      ...
      <div class="h-full ml-14 mt-14 mb-10 md:ml-64">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 p-4 gap-4">
          ...
          <div class="bg-blue-500 dark:bg-gray-800 shadow-lg rounded-md flex items-center justify-between p-3 border-b-4 border-blue-600 dark:border-gray-600 text-white font-medium group">
            <div class="flex justify-center items-center w-14 h-14 bg-white rounded-full transition-all duration-300 transform group-hover:rotate-12">
                <svg width="85px" height="85px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><g id="SVGRepo_bgCarrier" stroke-width="0"></g><g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g><g id="SVGRepo_iconCarrier"><path d="M19.92 5.777 18.223 4.08a.8.8 0 0 0-1.132 0L5.636 15.536 4.93 19.07l3.535-.707L19.92 6.909a.8.8 0 0 0 0-1.132Z" fill="#000000" fill-opacity=".16" stroke="#000000" stroke-width="1.5" stroke-miterlimit="10" stroke-linejoin="round"></path><path d="m14.828 6.343 2.829 2.829" stroke="#000000" stroke-width="1.5" stroke-miterlimit="10" stroke-linecap="round"></path></g></svg>
            </div>
            <div class="text-right">
              <p class="text-2xl">{{ $postingCount }}</p>
              <p>Post</p>
            </div>
          </div>
        </div>
...
<div class="relative flex flex-col min-w-0 break-words bg-gray-50 dark:bg-gray-800 w-full shadow-lg rounded">
  <div class="flex justify-between">
    <div>
      <h5 class="leading-none text-3xl font-bold text-gray-900 dark:text-white pb-2 pl-5">chart</h5>
      <p class="text-base font-normal text-gray-500 dark:text-gray-400 pl-5">Visitors this week</p>
    </div>
    <div
                        ...
                        <td class="px-4 py-3">
                          <div class="flex items-center text-sm">
                            <div class="relative hidden w-8 h-8 mr-3 rounded-full md:block">
                              @if($p->gambar)
                                <img class="object-cover w-full h-full rounded-full" src="{{ asset('images/' . $p->gambar) }}" alt="Gambar" loading="lazy" />
                              @else
                                <img class="object-cover w-full h-full rounded-full" src="https://via.placeholder.com/150" alt="Tidak ada gambar" loading="lazy" />
                              @endif
                              <div class="absolute inset-0 rounded-full shadow-inner" aria-hidden="true"></div>
                            </div>
                            <div>
                              <p class="font-semibold">{{$p->title}}</p>
                              <p class="text-xs text-gray-600 dark:text-gray-400">{{$p->admin}}</p>
                            </div>
                          </div>
                        </td>
                        <td class="px-4 py-3 text-sm">{{ substr($p->konten, 0, 100) }}</td>
                        <td class="px-4 py-3 text-xs">
                          @if($p->gambar)
                            <img src="{{ asset('images/' . $p->gambar) }}" alt="Gambar" class="thumbnail  w-8 h-8 mr-3">
                          @else
                            Tidak ada gambar
                          @endif
                        </td>
