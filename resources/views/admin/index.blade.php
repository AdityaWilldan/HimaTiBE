...
<h1 class="text-3xl mb-4 text-center">Daftar Artikel</h1>
    
 <!-- Navbar -->
 <nav class="bg-gray-800 dark:bg-gray-900 rounded-lg">
        <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
            <a href="#" class="flex items-center">
                <img src="{{asset('/img/logo-removebg-preview.png')}}" class="h-8 mr-3" alt="Flowbite Logo" />
            </a>
            ...
            <div class="hidden w-full md:block md:w-auto" id="navbar-solid-bg">
                ...
                md:border-0 md:bg-transparent dark:bg-gray-900 md:dark:bg-transparent dark:border-gray-700">
                    <li>
                        <a href="/" class="block py-2 pl-3 pr-4 text-white bg-purple-500 rounded md:bg-transparent
                         md:text-purple-500 md:p-0 md:dark:text-purple-500 dark:bg-purple-600 md:dark:bg-transparent" aria-current="page">Main Web</a>
                    </li>
                    <li>
                        <a href="/create" class="block py-2 pl-3 pr-4 text-gray-300 rounded hover:bg-gray-700 md:hover:bg-transparent md:border-0 
