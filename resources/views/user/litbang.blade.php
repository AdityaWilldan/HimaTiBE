        ...
        <header class="sticky-top">
          ...
          <nav class="backdrop-blur-sm rounded p-2">
            ...
            <div class="py-8 px-4 mx-auto max-w-screen-xl text-center lg:py-16 lg:px-12">
                ...
                <h1 class="typing-animation-text mb-4 text-4xl font-extrabold tracking-tight leading-none text-slate-400 text-bold md:text-5xl lg:text-5xl dark:text-slate fade-in-right" data-aos="fade-right">LITBANG<br></h1>
                <p class="mb-8 text-lg font-bold text-gray-500 lg:text-xl sm:px-16 xl:px-48 text-sky-800 slide-in2" data-aos="fade-left">
                    ...
                    <br>
                <span class="mb-8 text-lg text-center font-normal text-gray-500  dark:text-slate-400 poppins">(Litbang) berfokus pada eksplorasi ilmu dan pengembangan ide-ide inovatif. 
