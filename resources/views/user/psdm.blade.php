                  ...
                  <section class="pt-50 pb-32 relative bg-slate-950">
                    ...
                    <!-- <section class="bg-slate-950 pt-30"> -->
                      <div class="py-8 px-4 mx-auto max-w-screen-xl text-center lg:py-16 lg:px-12">
                          ...
                          <h1 class="typing-animation-text mb-4 text-4xl font-extrabold tracking-tight leading-none text-slate-400 text-bold md:text-5xl lg:text-5xl dark:text-slate fade-in-right" data-aos="fade-right">PSDM<br></h1>
          ...
          <div class="container">
              ...
              <div class="w-full px-4 flex flex-wrap justify-center xl:w-10/12 xl:mx-auto">
                  <div class="mb-12 p-4 md:w-1/2" data-aos="fade-up">
                      ...
                      <h3 class="font-semibold text-xl text-blue-900 mt-5 mb-3">Simulasi Sidang</h3>
                  ...
                  <div class="mb-12 p-4 md:w-1/2" data-aos="fade-up">
                      <div class="rounded-md shadow-mb overflow-hidden">
                          <img src="/img/ldkm2.JPG" alt="Landing Page" width="w-full" />
                      </div>
                      <h3 class="font-semibold text-xl text-blue-900 mt-5 mb-3">Upgrading</h3>
