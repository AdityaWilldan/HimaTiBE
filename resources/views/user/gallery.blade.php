    ...
    <section class="">
        <div class="container px-6 py-10 mx-auto">
            <div class="text-center">
                <h1 class="text-5xl font-semibold  capitalize  bg-gradient-to-r from-green-500 via-blue-500 to-purple-600 bg-clip-text text-3xl font-extrabold text-transparent">HimaTI News</h1>
    
                <p class="max-w-lg mx-auto mt-4 text-slate-300 text-2xl">
                    ...
                    <div id="blog-posts">
                        ...
                        <div class="mt-8">
                            ...
                            <div class="flex items-center justify-between mt-4">
                                ...
                                <a href="{{ route('user.singlepost', ['id' => $p->id]) }}" class="inline-block text-blue-500 underline hover:text-blue-400">
