                  ...
                  <section class="pt-50 pb-32 relative bg-slate-950">
                    ...
                    <!-- <section class="bg-slate-950 pt-30"> -->
                      <div class="py-8 px-4 mx-auto max-w-screen-xl text-center lg:py-16 lg:px-12">
                          ...
                          <h1 class="typing-animation-text mb-4 text-4xl font-extrabold tracking-tight leading-none text-slate-400 text-bold md:text-5xl lg:text-5xl dark:text-slate fade-in-right" data-aos="fade-right">KOMPUB<br></h1>
                          <p class="mb-8 text-lg font-bold text-gray-500 lg:text-xl sm:px-16 xl:px-48 text-sky-500 slide-in2" data-aos="fade-left">
                             Departemen Komunikasi Publik
                              <br>
                          <span class="mb-8 text-lg text-center font-normal text-slate-200 poppins">(Kompub) adalah ujung tombak dalam menjalin komunikasi antara HIMA dan mahasiswa Teknik Informatika. Kami bertugas untuk menyampaikan informasi penting, mengadakan acara-acara komunikasi, 
                            dan menjaga terjalinnya hubungan yang erat antara HIMA dan anggotanya.</span>
                          </p>
          ...
          <div class="container">
              <div class="w-full px-4">
                  <div class="max-w xl mx-auto text-center mb-16">
                      <h2 class="font-bold text-slate-500 text-3xl mb-4 sm:text-4xl lg:text-5xl" data-aos="fade-up"">Program Kerja Departemen Kompub</h2>
                      <p class="font-medium text-md text-sky-500 md:text-lg" data-aos="fade-up">Berikut Kegiatan Dan Proker Departemen Komunikasi Publik.</p>
                  </div>
              </div>
              ...
              <div class="w-full px-4 flex flex-wrap justify-center xl:w-10/12 xl:mx-auto">
                  <div class="mb-12 p-4 md:w-1/2"  data-aos="fade-up">
                      ...
                      <h3 class="font-semibold text-xl text-blue-900 mt-5 mb-3">Studi Banding</h3>
                  ...
                  <div class="mb-12 p-4 md:w-1/2" data-aos="fade-up">
                      <div class="rounded-md shadow-mb overflow-hidden">
                          <img src="/img/kompub2.jpg" alt="Landing Page" width="w-full" />
                      </div>
                      <h3 class="font-semibold text-xl text-blue-900 mt-5 mb-3">Olahraga</h3>
                      <p class="font-medium text-base text-slate-400">Departemen Komunikasi Publik (Kompub) HIMA Teknik Informatika juga meyakini bahwa menjaga komunikasi yang baik melibatkan beragam kegiatan, termasuk olahraga. Salah satu cara kami menjaga kebersamaan dan semangat tim adalah melalui kegiatan badminton yang menyenangkan.</p>
                  </div>
                  <div class="mb-12 p-4 md:w-1/2" data-aos="fade-up">
                      <div class="rounded-md shadow-mb overflow-hidden">
                          <img src="/img/kompub4.jpg" alt="Landing Page" width="w-full" />
                      </div>
                      <h3 class="font-semibold text-xl text-blue-900 mt-5 mb-3">Olahraga</h3>
                      <p class="font-medium text-base text-slate-400">Olahraga tidak hanya menjadi sarana untuk meningkatkan kesehatan dan kebugaran, tetapi juga menjadi wadah yang efektif untuk mempererat hubungan antaranggota. Melalui setiap pukulan raket dan langkah di lapangan, kami membangun kekompakan, kepercayaan, dan semangat sportifitas.</p>
                  </div>
              </div>
          </div>
      </section> 
      ...
      <div class="container my-24 mx-auto md:px-6">
        ...
        <section class="mb-32 text-center">
          <h2 class="mb-12 text-3xl font-bold text-slate-400" data-aos="fade-up">
            Kepengurusan <u class="text-primary dark:text-primary-400">Kompub</u>
          </h2>
