...
<div id="controls-carousel" class="relative w-full slide-up" data-carousel="static">
    ...
    <button type="button" class="absolute top-0 right-0 z-30 flex items-center justify-center h-full px-4 cursor-pointer group focus:outline-none" data-carousel-next>
        ...
        <section class=" dark:text-gray-100">
          <div class="container flex flex-col lg:flex-row justify-center items-center p-6 mx-auto sm:py-12 lg:py-24">
            ...
            <div class="lg:w-1/2 flex flex-col justify-center p-6 text-center lg:text-left" data-aos="fade-left">
              <h1 class="text-5xl font-bold leading-tight sm:text-6xl text-slate-500 bg-gradient-to-r from-green-500 via-blue-500 to-purple-600 bg-clip-text text-3xl font-extrabold text-transparent">Welcome To
              ...
              <div class="flex flex-col space-y-4 sm:items-center sm:justify-center sm:flex-row sm:space-y-0 sm:space-x-4 lg:justify-start">
                <button></button>
                <a rel="noopener noreferrer" href="{{url('/gallery')}}" style="box-shadow: 3px 3px 10px #2563eb, -3px -3px 20px #1d4ed8;" class="hover:opacity-80 transition duration-300 ease-in-out px-8 py-3 text-lg font-semibold rounded hover:text-gray-300 bg-blue-500 hover:bg-blue-800 dark:text-gray-900" data-aos="fade-right">Gallery Berita</a>
              </button>
        ...
        <!-- team section -->
        <div class="flex items-center justify-center min-h-screen  py-30">
                          ...
                          <div class="w-full md:w-6/12 lg:w-3/12 mb-6 px-6 sm:px-6 lg:px-4" data-aos="fade-up">
                              <div class="flex flex-col">
                                  ...
                                  <div class="text-center mt-6">
                                      <!-- Name -->
                                      <h1 class="text-gray-400 text-2xl font-bold mb-1">
                                         ahmad muqodas
                                      </h1>
      
                                      <!-- Title -->
                                      <div class="text-primary font-medium mb-2 text-xl">
